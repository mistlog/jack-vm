...
*/
<Memory /> + function Resolve(this: Memory & IMemory, segment: SegmentType, index: number)
{
...
<Memory /> + function constructor(this: Memory, size: number)
{
...
<Memory /> + function Read(this: Memory, address: number)
{
    return this.m_Memory[address];
};

<Memory /> + function Write(this: Memory, address: number, value: number)
{
    this.m_Memory[address] = value;
    return this;
};

<Memory /> + function Dump(this: Memory, start: number, end: number)
{
