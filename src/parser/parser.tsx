import { ICommand } from "../core/vm";
import { Push, Add, Subtract, Negate, Equality, GreaterThan, LessThan, And, Or, Not, Pop, Label, Goto, IfGoto, Return, Call, DeclareFunction } from "../core/command";
...
*/
<CodeParser /> + function constructor(this: CodeParser, code: string, file?: string)
{
    //@ts-ignore
    <PreprocessCode />;
...
<CodeParser /> + function Parse(this: CodeParser)
{
...
{
    const label_map = new Map<string, Map<string, string>>();
    ...
    this.m_Code.forEach(code =>
    {
        ...
        if (name === "function")
        {
            ...
            label_map.set(current_function, new Map<string, string>());
